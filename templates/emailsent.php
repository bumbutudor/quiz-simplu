    ...
    <div id="container" class="quiz">
        <div class="row row-offcanvas row-offcanvas-right">
            <div class="col-xs-12 col-sm-9">
                ...
                <div class="jumbotron">
                    <p>Multumim pentru inregistrare. Verificați căsuța de e-mail. Un e-mail a fost trimis la adresa dvs. de e-mail. Va trebui să confirmați e-mailul înainte de a avea acces la teste.</p>
                </div>
            </div><!--/span-->
